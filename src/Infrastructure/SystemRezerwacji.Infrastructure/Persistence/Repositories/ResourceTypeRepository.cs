// SystemRezerwacji.Infrastructure/Persistence/Repositories/ResourceTypeRepository.cs
using Microsoft.EntityFrameworkCore;
using SystemRezerwacji.Application.Interfaces.Persistence;
using SystemRezerwacji.Domain.Entities;
using SystemRezerwacji.Infrastructure.Persistence.DbContext; // Upewnij się, że jest poprawna ścieżka
using System;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SystemRezerwacji.Infrastructure.Persistence.Repositories;
